                ...
                <main class="product-page__product-info">
                    ...
                    <div class="product-page__product-info__reviews-price">
                        <div class="product-page__product-info__rating">
                            <div class="stars">
                                <img class="star" v-for="i in parseInt(product.star)" :key="i" v-if="i <= product.star"
                                     :src="i <= product.star ? '/pics/svg/star.svg': ''" alt="star(s)">
                            </div>
                ...
                <div class="product-page__props">
                    ...
                    <div class="product-page__props__content">
                        <div class="product-page__props__col">
                            <span class="prop" v-for="(prop,i) in JSON.parse(product.property[$i18n.locale])" :key="i"
                                  v-if="prop.key">{{ prop.key }}:</span>
                        </div>
                        <div class="product-page__props__col">
                            <span class="value" v-for="(prop,i) in JSON.parse(product.property[$i18n.locale])" :key="i"
                                  v-if="prop.value">{{ prop.value }}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product-page__input-area__top">
                        ...
                        <div class="product-page__input-area__col">
                            <div class="product-page__input-area__colors">
                                <ColorChooser :colors="product.color.split(' ')" :chosen="chosenColor" :radio="true"
